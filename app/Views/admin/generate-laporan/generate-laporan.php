                  ...
                  <div class="nav-tabs-navigation">
                     <div class="row">
                        <div class="col">
                           ...
                           <p class="card-category">Laporan absen karyawan</p>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="card h-100">
                           <form action="<?= base_url('admin/laporan/karyawan'); ?>" method="post" class="card-body d-flex flex-column">
                              <h4 class="text-success"><b>Laporan Absen Karyawan</b></h4>
                              <p>Total Jumlah Karyawan : <b><?= count($karyawan); ?></b></p>
                              <div class="row align-items-center">
                                 <div class="col-auto">
                                    <p class="d-inline"><b>Bulan :</b></p>
                                 </div>
                                 <div class="col-5">
                                    <input type="month" name="tanggalKaryawan" id="tanggalKaryawan" class="form-control" value="<?= date('Y-m'); ?>">
                                 </div>
                              </div>
